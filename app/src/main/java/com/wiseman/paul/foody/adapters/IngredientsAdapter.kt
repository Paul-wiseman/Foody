...
import com.wiseman.paul.foody.databinding.IngredientsRowLayoutBinding
import com.wiseman.paul.foody.models.ExtendedIngredient
import com.wiseman.paul.foody.util.Constants.Companion.BASE_IMAGE_URL
...
class IngredientsAdapter: RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    fun setData(newIngredients: List<ExtendedIngredient>) {
        val ingredientsDiffUtil =
            FoodRecipeDiffUtil(ingredientsList, newIngredients)
